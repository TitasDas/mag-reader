...
# System WebView libraries (Debian/Ubuntu; see tauri.app for other distros)
...
npm run tauri:build    # produce a .deb and AppImage in src-tauri/target/release/bundle/
```
